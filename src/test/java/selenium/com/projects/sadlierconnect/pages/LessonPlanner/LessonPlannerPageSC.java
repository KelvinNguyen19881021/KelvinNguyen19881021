package selenium.com.projects.sadlierconnect.pages.LessonPlanner;
...
public class LessonPlannerPageSC extends CommonPageSC {

    public LessonPlannerPageSC() {
        super();
    }
    ...
    public LessonPlannerPageSC openDashboardPage() {
