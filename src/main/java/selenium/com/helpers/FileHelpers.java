...
public class FileHelpers {
    ...
    public static boolean compareImages(String file1Path, String file2Path) throws IOException {
        BufferedImage img1 = ImageIO.read(new File(file1Path));
        BufferedImage img2 = ImageIO.read(new File(file2Path));
    ...
    public static void deleteDirectory(String path) {
        ...
        try {
            ...
            // Kiểm tra xem đường dẫn có phải thư mục hay không
            ...
            if(Files.list(directory).findAny().isEmpty()) {
                ...
                throw new IllegalArgumentException("Folder is not empty, cannot be deleted!!!");
            }
