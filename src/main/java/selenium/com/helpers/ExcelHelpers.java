...
import selenium.com.exceptions.InvalidPathForExcelException;
...
public class ExcelHelpers {
    ...
    public void setCellData(String text, int rowNumber, int colNumber) {
        try {
            ...
            if (text.equalsIgnoreCase("pass") || text.equalsIgnoreCase("passed") || text.equalsIgnoreCase("success")) {
    ...
    // Write data to excel sheet
    public void setCellDataUsingBorder(String text, int rowNumber, int colNumber) {
        try {
            row = sheet.getRow(rowNumber);
            if (row == null) {
                row = sheet.createRow(rowNumber);
