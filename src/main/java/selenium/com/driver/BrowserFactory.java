...
import selenium.com.exceptions.HeadlessNotSupportedException;
...
public enum BrowserFactory {
    ...
    CHROME {
        ...
        public FirefoxOptions getOptions() {
            ...
            options.addPreference("browser.urlbar.Suggest.searches", false);
            if (Boolean.valueOf(FrameworkConstants.HEADLESS) == true) {
        ...
        public EdgeOptions getOptions() {
            ...
            options.addArguments("window-size=1920,1080");
            options.setPageLoadStrategy(PageLoadStrategy.NONE);
            options.setCapability("disable-component-update", true);
            if (Boolean.valueOf(FrameworkConstants.HEADLESS) == true) {
                options.addArguments("--headless=new");
                //options.addArguments("window-size=1920,1080");
            }
